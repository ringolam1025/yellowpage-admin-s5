...
export interface ApiDirectoryDirectory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    opening_hours: Schema.Attribute.Component<'shop.opening-hours', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Component<'event.category', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiShopTierShopTier extends Struct.CollectionTypeSchema {
  collectionName: 'shop_tiers';
  info: {
    displayName: 'ShopTier';
    pluralName: 'shop-tiers';
    singularName: 'shop-tier';
  };
  options: {
    draftAndPublish: true;
  };
